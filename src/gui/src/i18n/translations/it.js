...
const it = {
  ...
  dictionary: {
    ...
    web_link: "Collegamento Web",
    enter_url_for_web_link: "Inserisci l'URL per il collegamento web:",
    url_must_start_with_http: "L'URL deve iniziare con http:// o https://",
    failed_to_open_url: "Impossibile aprire l'URL. Controlla le impostazioni dei popup del browser.",
    invalid_url_in_weblink: "URL non valido memorizzato in questo file di collegamento web.",
    error_reading_weblink: "Errore durante la lettura del file di collegamento web.",
    language: "Lingua",
    license: "Licenza",
