...
const hy = {
    ...
    dictionary: {
        ...
        web_link: "Վեբ հղում",
        enter_url_for_web_link: "Մուտքագրեք URL-ը վեբ հղման համար:",
        url_must_start_with_http: "URL-ը պետք է սկսվի http:// կամ https:// -ով",
        failed_to_open_url: "Չհաջողվեց բացել URL-ը: Ստուգեք ձեր զննարկիչի փոփ-ափ պատուհանների կարգավորումները:",
        invalid_url_in_weblink: "Անվավեր URL-ը պահված է այս վեբ հղման ֆայլում:",
        error_reading_weblink: "Սխալ վեբ հղման ֆայլը կարդալիս:",
        language: "Լեզու",
        license: "Լիցենզիա",
