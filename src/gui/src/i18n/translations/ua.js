...
const ua = {
    ...
    dictionary: {
        ...
        web_link: "Веб-посилання",
        enter_url_for_web_link: "Введіть URL для веб-посилання:",
        url_must_start_with_http: "URL повинен починатися з http:// або https://",
        failed_to_open_url: "Не вдалося відкрити URL. Перевірте налаштування спливаючих вікон браузера.",
        invalid_url_in_weblink: "Недійсний URL збережено в цьому файлі веб-посилання.",
        error_reading_weblink: "Помилка при читанні файлу веб-посилання.",
        language: "Мова",
        license: "Ліцензія",
