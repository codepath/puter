...
const ja = {
    ...
    dictionary: {
        ...
        web_link: "ウェブリンク",
        enter_url_for_web_link: "ウェブリンクのURLを入力してください:",
        url_must_start_with_http: "URLはhttp://またはhttps://で始まる必要があります",
        failed_to_open_url: "URLを開けませんでした。ブラウザのポップアップ設定を確認してください。",
        invalid_url_in_weblink: "このウェブリンクファイルに保存されているURLが無効です。",
        error_reading_weblink: "ウェブリンクファイルの読み取りエラー。",
        language: "言語",
        license: "ライセンス",
        lightness: '明るさ',
