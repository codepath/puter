...
const ku = {
  ...
  dictionary: {
    ...
    web_link: "بەستەری وێب",
    enter_url_for_web_link: "ناونیشانی URL بۆ بەستەری وێب بنووسە:",
    url_must_start_with_http: "URL دەبێت بە http:// یان https:// دەست پێبکات",
    failed_to_open_url: "نەتوانرا URL بکەرێتەوە. تکایە ڕێکخستنەکانی پۆپ-ئەپی وێبگەڕەکەت بپشکنە.",
    invalid_url_in_weblink: "URL نادروست لەم فایلە بەستەری وێبەدا هەڵگیراوە.",
    error_reading_weblink: "هەڵە لەخوێندنەوەی فایلی بەستەری وێب.",
    language: "زمان",
    license: "لایسەنس",
    lightness: "رووناکی",
