...
const ru = {
  ...
  dictionary: {
    ...
    web_link: "Веб-ссылка",
    enter_url_for_web_link: "Введите URL для веб-ссылки:",
    url_must_start_with_http: "URL должен начинаться с http:// или https://",
    failed_to_open_url: "Не удалось открыть URL. Пожалуйста, проверьте настройки всплывающих окон вашего браузера.",
    invalid_url_in_weblink: "Неверный URL, сохраненный в этом файле веб-ссылки.",
    error_reading_weblink: "Ошибка при чтении файла веб-ссылки.",
    language: 'Язык',
    license: 'Лицензия',
