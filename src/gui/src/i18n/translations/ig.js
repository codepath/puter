...
const ig = {
  ...
  dictionary: {
    ...
    web_link: "Njikọ Weebụ",
    enter_url_for_web_link: "Tinye URL maka njikọ weebụ:",
    url_must_start_with_http: "URL ga-amalite na http:// ma ọ bụ https://",
    failed_to_open_url: "Emeghị ka URL meghee. Biko lelee ntọala popup nke ihe nchọgharị gị.",
    invalid_url_in_weblink: "URL na-adịghị mma echekwara na faịlụ njikọ weebụ a.",
    error_reading_weblink: "Njehie mgbe ị na-agụ faịlụ njikọ weebụ.",
    language: "Asụsụ",
    license: "ikike",
    lightness: "ìhè",
