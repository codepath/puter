...
const th = {
    ...
    dictionary: {
        ...
        web_link: "ลิงก์เว็บ",
        enter_url_for_web_link: "ป้อน URL สำหรับลิงก์เว็บ:",
        url_must_start_with_http: "URL ต้องเริ่มต้นด้วย http:// หรือ https://",
        failed_to_open_url: "ไม่สามารถเปิด URL ได้ กรุณาตรวจสอบการตั้งค่าป๊อปอัปของเบราว์เซอร์",
        invalid_url_in_weblink: "URL ที่ไม่ถูกต้องเก็บไว้ในไฟล์ลิงก์เว็บนี้",
        error_reading_weblink: "เกิดข้อผิดพลาดในการอ่านไฟล์ลิงก์เว็บ",
        language: "ภาษา",
        license: "ใบอนุญาต",
        lightness: 'ความสว่าง',
