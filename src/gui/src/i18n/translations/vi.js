...
const vi = {
    ...
    dictionary: {
        ...
        url_must_start_with_http: "URL phải bắt đầu bằng http:// hoặc https://",
        failed_to_open_url: "Không thể mở URL. Vui lòng kiểm tra cài đặt popup của trình duyệt.",
        invalid_url_in_weblink: "URL không hợp lệ được lưu trữ trong tệp liên kết web này.",
        error_reading_weblink: "Lỗi khi đọc tệp liên kết web.",
        language: "Ngôn ngữ",
        license: "Giấy phép",
        lightness: 'Độ sáng',
