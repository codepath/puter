...
const ro = {
    ...
    dictionary: {
        ...
        web_link: "Link Web",
        enter_url_for_web_link: "Introduceți URL-ul pentru linkul web:",
        url_must_start_with_http: "URL-ul trebuie să înceapă cu http:// sau https://",
        failed_to_open_url: "Nu s-a putut deschide URL-ul. Vă rugăm să verificați setările de popup ale browserului dvs.",
        invalid_url_in_weblink: "URL invalid stocat în acest fișier de link web.",
        error_reading_weblink: "Eroare la citirea fișierului de link web.",
        language: "Limbă",
        license: "Licență",
