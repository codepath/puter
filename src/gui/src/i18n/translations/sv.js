...
const sv = {
    ...
    dictionary: {
        ...
        web_link: "Webblänk",
        enter_url_for_web_link: "Ange URL för webbänken:",
        url_must_start_with_http: "URL måste börja med http:// eller https://",
        failed_to_open_url: "Kunde inte öppna URL. Kontrollera webbläsarens popup-inställningar.",
        invalid_url_in_weblink: "Ogiltig URL lagrad i denna webbänkfil.",
        error_reading_weblink: "Fel vid läsning av webbänkfilen.",
        language: "Språk",
        license: "Licens",
        lightness: "Ljus",
