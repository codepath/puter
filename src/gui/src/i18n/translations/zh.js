...
const zh = {
    ...
    dictionary: {
        ...
        web_link: "网页链接",
        enter_url_for_web_link: "请输入网页链接的URL:",
        url_must_start_with_http: "URL必须以http://或https://开头",
        failed_to_open_url: "无法打开URL。请检查浏览器的弹窗设置。",
        invalid_url_in_weblink: "此网页链接文件中存储的URL无效。",
        error_reading_weblink: "读取网页链接文件时出错。",
        language: "语言",
        license: "许可协议",
        lightness: '明亮',
        link_copied: "链接已复制",
