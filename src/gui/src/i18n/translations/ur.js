...
const ur = {
  ...
  dictionary: {
    ...
    web_link: "ویب لنک",
    enter_url_for_web_link: "ویب لنک کے لیے URL درج کریں:",
    url_must_start_with_http: "URL http:// یا https:// سے شروع ہونا چاہیے",
    failed_to_open_url: "URL کھولنے میں ناکام. براہ کرم اپنے براؤزر کی پاپ اپ کی ترتیبات چیک کریں۔",
    invalid_url_in_weblink: "اس ویب لنک فائل میں محفوظ غلط URL۔",
    error_reading_weblink: "ویب لنک فائل پڑھنے میں خرابی۔",
    language: "زبان",
    license: "License",
    lightness: "لائسنس",
