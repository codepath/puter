...
const nl = {
	...
	dictionary: {
		...
		web_link: "Weblink",
		enter_url_for_web_link: "Voer de URL voor de weblink in:",
		url_must_start_with_http: "URL moet beginnen met http:// of https://",
		failed_to_open_url: "Kan URL niet openen. Controleer de pop-upinstellingen van uw browser.",
		invalid_url_in_weblink: "Ongeldige URL opgeslagen in dit weblinkbestand.",
		error_reading_weblink: "Fout bij het lezen van het weblinkbestand.",
		language: 'Taal',
		license: 'Licentie',
