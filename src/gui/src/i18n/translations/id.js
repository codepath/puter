...
const id = {
  ...
  dictionary: {
    ...
    web_link: "Tautan Web",
    enter_url_for_web_link: "Masukkan URL untuk tautan web:",
    url_must_start_with_http: "URL harus dimulai dengan http:// atau https://",
    failed_to_open_url: "Gagal membuka URL. Silakan periksa pengaturan popup browser Anda.",
    invalid_url_in_weblink: "URL tidak valid yang disimpan dalam file tautan web ini.",
    error_reading_weblink: "Kesalahan membaca file tautan web.",
    language: "Bahasa",
    license: "Lisensi",
    lightness: "Kecerahan",
