...
const zhtw = {
    ...
    dictionary: {
        ...
        web_link: "網頁連結",
        enter_url_for_web_link: "請輸入網頁連結的URL:",
        url_must_start_with_http: "URL必須以http://或https://開頭",
        failed_to_open_url: "無法開啟URL。請檢查瀏覽器的彈出視窗設定。",
        invalid_url_in_weblink: "此網頁連結檔案中儲存的URL無效。",
        error_reading_weblink: "讀取網頁連結檔案時發生錯誤。",
        language: "語言",
        license: "授權",
        lightness: '亮度',
        link_copied: "連結已複製",
