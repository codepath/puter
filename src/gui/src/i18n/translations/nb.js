...
const nb = {
    ...
    dictionary: {
        ...
        web_link: "Weblenke",
        enter_url_for_web_link: "Skriv inn URL for weblenken:",
        url_must_start_with_http: "URL må starte med http:// eller https://",
        failed_to_open_url: "Kunne ikke åpne URL. Sjekk nettleserens popup-innstillinger.",
        invalid_url_in_weblink: "Ugyldig URL lagret i denne weblenkefilen.",
        error_reading_weblink: "Feil ved lesing av weblenkefilen.",
        loading: 'Laster',
        log_in: "Logg inn",
