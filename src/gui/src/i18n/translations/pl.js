...
const pl = {
    ...
    dictionary: {
        ...
        web_link: "Link internetowy",
        enter_url_for_web_link: "Wprowadź adres URL dla linku internetowego:",
        url_must_start_with_http: "URL musi zaczynać się od http:// lub https://",
        failed_to_open_url: "Nie udało się otworzyć adresu URL. Sprawdź ustawienia wyskakujących okienek w przeglądarce.",
        invalid_url_in_weblink: "Nieprawidłowy adres URL zapisany w tym pliku linku internetowego.",
        error_reading_weblink: "Błąd podczas odczytywania pliku linku internetowego.",
        language: "Język",
        license: "Licencja",
        lightness: 'Jasność',
