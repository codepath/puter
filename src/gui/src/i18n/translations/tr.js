...
const tr = {
    ...
    dictionary: {
        ...
        enter_url_for_web_link: "Web bağlantısı için URL'yi girin:",
        url_must_start_with_http: "URL http:// veya https:// ile başlamalıdır",
        failed_to_open_url: "URL açılamadı. Lütfen tarayıcınızın açılır pencere ayarlarını kontrol edin.",
        invalid_url_in_weblink: "Bu web bağlantısı dosyasında saklanan geçersiz URL.",
        error_reading_weblink: "Web bağlantısı dosyası okunurken hata oluştu.",
        language: "Dil",
        license: "Lisans",
        lightness: "Aydınlık",
